// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_rdfifo_data.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_rdfifo_data
// Source Path: rx_dma_test/rx_dma_test_axi4/rx_dma_test_axi4_module/rx_dma_test_rdfifo_data
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module rx_dma_test_rdfifo_data
  ...
  rx_dma_test_SimpleDualPortRAM_generic #(.AddrWidth(4),
                                        ...
                                        u_rx_dma_test_rdfifo_data_classic_ram_generic (.clk(clk),
                                                                                       .enb(enb),
                                                                                       .wr_din(In),
                                                                                       .wr_addr(w_waddr),
                                                                                       .wr_en(w_we),  // ufix1
...
endmodule  // rx_dma_test_rdfifo_data
