// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_axi4_module.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_axi4_module
// Source Path: rx_dma_test/rx_dma_test_axi4/rx_dma_test_axi4_module
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module rx_dma_test_axi4_module
  ...
  rx_dma_test_rdfifo_data u_rx_dma_test_rdfifo_data_inst (.clk(clk),
                                                          .reset(reset),
                                                          .enb(const_1),
                                                          .In(data_read),  // ufix32
  ...
  rx_dma_test_rdfifo_rid u_rx_dma_test_rdfifo_rid_inst (.clk(clk),
                                                        .reset(reset),
                                                        .enb(const_1),
                                                        .In(rid_int),  // ufix12
                                                        .Push(ar_transfer),  // ufix1
  ...
  rx_dma_test_rdfifo_last u_rx_dma_test_rdfifo_last_inst (.clk(clk),
                                                          .reset(reset),
                                                          .enb(const_1),
                                                          .In(rlast_int),  // ufix1
                                                          .Push(ar_transfer),  // ufix1
...
endmodule  // rx_dma_test_axi4_module
