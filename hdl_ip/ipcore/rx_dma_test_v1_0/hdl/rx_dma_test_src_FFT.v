// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_src_FFT.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_src_FFT
// Source Path: rx_dma_test/LDCR_D/Channelizer_CH1/FFT
// Hierarchy Level: 2
// Model version: 9.535
// 
// -------------------------------------------------------------
...
module rx_dma_test_src_FFT
  ...
  input   reset;
  input   enb;
  input   signed [13:0] filterOut_cmplx_re;  // sfix14_En5
  input   signed [13:0] filterOut_cmplx_im;  // sfix14_En5
  input   filterOut_vld;
  output  startOut;
  output  endOut;
  ...
  wire softReset;
  reg signed [13:0] intdelay_reg [0:2];  // sfix14 [3]
  reg signed [13:0] intdelay_reg_next [0:2];  // sfix14_En5 [3]
  reg signed [13:0] din_1_1_re_dly;  // sfix14_En5
  reg signed [13:0] intdelay_reg_1 [0:2];  // sfix14 [3]
  reg signed [13:0] intdelay_reg_next_1 [0:2];  // sfix14_En5 [3]
  reg signed [13:0] din_1_1_im_dly;  // sfix14_En5
  ...
  wire proc_2_enb;
  wire multiply_2_J;
  wire signed [15:0] dout_2_1_re;  // sfix16_En5
  wire signed [15:0] dout_2_1_im;  // sfix16_En5
  wire dout_2_1_vld;
  reg signed [15:0] intdelay_reg_3 [0:2];  // sfix16 [3]
  reg signed [15:0] intdelay_reg_next_2 [0:2];  // sfix16_En5 [3]
  reg signed [15:0] din_3_1_re_dly;  // sfix16_En5
  reg signed [15:0] intdelay_reg_4 [0:2];  // sfix16 [3]
  reg signed [15:0] intdelay_reg_next_3 [0:2];  // sfix16_En5 [3]
  reg signed [15:0] din_3_1_im_dly;  // sfix16_En5
  reg  [2:0] intdelay_reg_5;  // ufix1 [3]
  wire din_3_vld_dly;
  wire signed [13:0] twdl_3_1_re;  // sfix14_En12
  wire signed [13:0] twdl_3_1_im;  // sfix14_En12
  wire dinXTwdl_3_1_vld;
  wire [2:0] rd_3_Addr;  // ufix3
  wire rd_3_Enb;
  wire proc_3_enb;
  wire signed [16:0] dout_3_1_re;  // sfix17_En5
  wire signed [16:0] dout_3_1_im;  // sfix17_En5
  wire dout_3_1_vld;
  ...
  wire proc_4_enb;
  wire multiply_4_J;
  wire signed [17:0] dout_4_1_re;  // sfix18_En5
  wire signed [17:0] dout_4_1_im;  // sfix18_En5
  wire dout_4_1_vld;
  reg signed [17:0] intdelay_reg_6 [0:2];  // sfix18 [3]
  reg signed [17:0] intdelay_reg_next_4 [0:2];  // sfix18_En5 [3]
  reg signed [17:0] din_5_1_re_dly;  // sfix18_En5
  reg signed [17:0] intdelay_reg_7 [0:2];  // sfix18 [3]
  reg signed [17:0] intdelay_reg_next_5 [0:2];  // sfix18_En5 [3]
  reg signed [17:0] din_5_1_im_dly;  // sfix18_En5
  reg  [2:0] intdelay_reg_8;  // ufix1 [3]
  wire din_5_vld_dly;
  wire signed [13:0] twdl_5_1_re;  // sfix14_En12
  wire signed [13:0] twdl_5_1_im;  // sfix14_En12
  wire dinXTwdl_5_1_vld;
  wire rd_5_Addr;  // ufix1
  wire rd_5_Enb;
  wire proc_5_enb;
  wire signed [18:0] dout_5_1_re;  // sfix19_En5
  wire signed [18:0] dout_5_1_im;  // sfix19_En5
  wire dout_5_1_vld;
  ...
  wire proc_6_enb;
  wire multiply_6_J;
  wire signed [19:0] dout_6_1_re;  // sfix20_En5
  wire signed [19:0] dout_6_1_im;  // sfix20_En5
  wire dout_6_1_vld;
  wire startOutS;
  wire endOutS;
    ...
    begin : intdelay_process
      if (reset == 1'b1) begin
        for(intdelay_t_1 = 32'sd0; intdelay_t_1 <= 32'sd2; intdelay_t_1 = intdelay_t_1 + 32'sd1) begin
          intdelay_reg[intdelay_t_1] <= 14'sb00000000000000;
        end
      end
      else begin
        if (enb) begin
  ...
  always @* begin
    ...
    intdelay_reg_next[0] = filterOut_cmplx_re;
  ...
  always @* begin
    ...
    intdelay_reg_next_1[0] = filterOut_cmplx_im;
      ...
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (softReset == 1'b1) begin
            ...
            intdelay_reg_2[0] <= filterOut_vld;
  ...
  rx_dma_test_src_RADIX22FFT_CTRL1_1 u_CTRL1_1_1 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
  ...
  rx_dma_test_src_RADIX22FFT_SDF1_1 u_SDF1_1_1 (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .din_1_1_re_dly(din_1_1_re_dly),  // sfix14_En5
                                                .din_1_1_im_dly(din_1_1_im_dly),  // sfix14_En5
  ...
  rx_dma_test_src_RADIX22FFT_CTRL1_2 u_CTRL2_2_1 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dout_1_1_vld(dout_1_1_vld),
  ...
  rx_dma_test_src_RADIX22FFT_SDF2_2 u_SDF2_2_1 (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .dout_1_1_re(dout_1_1_re),  // sfix15_En5
                                                .dout_1_1_im(dout_1_1_im),  // sfix15_En5
  ...
  rx_dma_test_src_TWDLROM_3_1 u_twdlROM_3_1 (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
                                             .dout_2_1_vld(dout_2_1_vld),
  ...
  rx_dma_test_src_RADIX22FFT_CTRL1_3 u_CTRL1_3_1 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
  ...
  rx_dma_test_src_RADIX22FFT_SDF1_3 u_SDF1_3_1 (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .din_3_1_re_dly(din_3_1_re_dly),  // sfix16_En5
                                                .din_3_1_im_dly(din_3_1_im_dly),  // sfix16_En5
  ...
  rx_dma_test_src_RADIX22FFT_CTRL1_4 u_CTRL2_4_1 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dout_3_1_vld(dout_3_1_vld),
  ...
  rx_dma_test_src_RADIX22FFT_SDF2_4 u_SDF2_4_1 (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .dout_3_1_re(dout_3_1_re),  // sfix17_En5
                                                .dout_3_1_im(dout_3_1_im),  // sfix17_En5
    ...
    begin : intdelay_6_process
      if (reset == 1'b1) begin
        for(intdelay_t_1_3 = 32'sd0; intdelay_t_1_3 <= 32'sd2; intdelay_t_1_3 = intdelay_t_1_3 + 32'sd1) begin
          intdelay_reg_6[intdelay_t_1_3] <= 18'sb000000000000000000;
        end
      end
      else begin
        if (enb) begin
    ...
    begin : intdelay_7_process
      if (reset == 1'b1) begin
        for(intdelay_t_1_4 = 32'sd0; intdelay_t_1_4 <= 32'sd2; intdelay_t_1_4 = intdelay_t_1_4 + 32'sd1) begin
          intdelay_reg_7[intdelay_t_1_4] <= 18'sb000000000000000000;
        end
      end
      else begin
        if (enb) begin
  ...
  rx_dma_test_src_TWDLROM_5_1 u_twdlROM_5_1 (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
                                             .dout_4_1_vld(dout_4_1_vld),
  ...
  rx_dma_test_src_RADIX22FFT_CTRL1_5 u_CTRL1_5_1 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
  ...
  rx_dma_test_src_RADIX22FFT_SDF1_5 u_SDF1_5_1 (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .din_5_1_re_dly(din_5_1_re_dly),  // sfix18_En5
                                                .din_5_1_im_dly(din_5_1_im_dly),  // sfix18_En5
  ...
  rx_dma_test_src_RADIX22FFT_CTRL1_6 u_CTRL2_6_1 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dout_5_1_vld(dout_5_1_vld),
  ...
  rx_dma_test_src_RADIX22FFT_SDF2_6 u_SDF2_6_1 (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .dout_5_1_re(dout_5_1_re),  // sfix19_En5
                                                .dout_5_1_im(dout_5_1_im),  // sfix19_En5
  ...
  rx_dma_test_src_RADIX2FFT_bitNatural u_NaturalOrder_Stage (.clk(clk),
                                                             .reset(reset),
                                                             .enb(enb),
                                                             .dout_6_1_re(dout_6_1_re),  // sfix20_En5
                                                             .dout_6_1_im(dout_6_1_im),  // sfix20_En5
  ...
  assign endOut = endOutS;

endmodule  // rx_dma_test_src_FFT
