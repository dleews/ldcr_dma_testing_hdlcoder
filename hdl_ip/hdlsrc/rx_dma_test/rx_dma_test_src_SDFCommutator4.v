// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_src_SDFCommutator4.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_src_SDFCommutator4
// Source Path: rx_dma_test/LDCR_D/Channelizer_CH1/FFT/RADIX22FFT_SDF2_4/SDFCommutator4
// Hierarchy Level: 4
// Model version: 9.625
// 
// -------------------------------------------------------------
...
module rx_dma_test_src_SDFCommutator4
  ...
  input   enb;
  input   dout_3_1_vld;
  input   signed [17:0] xf_re;  // sfix18_En5
  input   signed [17:0] xf_im;  // sfix18_En5
  input   xf_vld;
  input   signed [17:0] dinf_re;  // sfix18_En5
  input   signed [17:0] dinf_im;  // sfix18_En5
  input   dinf_vld;
  input   signed [17:0] btf1_re;  // sfix18_En5
  input   signed [17:0] btf1_im;  // sfix18_En5
  input   signed [17:0] btf2_re;  // sfix18_En5
  input   signed [17:0] btf2_im;  // sfix18_En5
  input   btfout_vld;
  output  signed [17:0] wrData_re;  // sfix18_En5
  output  signed [17:0] wrData_im;  // sfix18_En5
  ...
  reg signed [17:0] SDFCummutator_out_re_next;  // sfix18_En5
  reg signed [17:0] SDFCummutator_out_im_next;  // sfix18_En5
  reg  SDFCummutator_out_vld_next;
  reg [1:0] SDFCummutator_wrAddr_reg_next;  // ufix2
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [17:0] SDFCummutator_wrData_re_reg_next;  // sfix18_En5
  reg signed [17:0] SDFCummutator_wrData_im_reg_next;  // sfix18_En5
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [17:0] SDFCummutator_wrXData_re_reg_next;  // sfix18_En5
  reg signed [17:0] SDFCummutator_wrXData_im_reg_next;  // sfix18_En5
  ...
  reg signed [17:0] wrData_re_1;  // sfix18_En5
  reg signed [17:0] wrData_im_1;  // sfix18_En5
  reg [1:0] wrAddr_1;  // ufix2
  reg  wrEnb_1;
  reg signed [17:0] xData_re;  // sfix18_En5
  reg signed [17:0] xData_im;  // sfix18_En5
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [17:0] dout0_re;  // sfix18_En5
  reg signed [17:0] dout0_im;  // sfix18_En5
  reg  dout0_vld;
  wire signed [17:0] xX_re;  // sfix18_En5
  wire signed [17:0] xX_im;  // sfix18_En5
  reg signed [17:0] SDFOutmux_btf2Pipe_re;  // sfix18
  reg signed [17:0] SDFOutmux_btf2Pipe_im;  // sfix18
  reg  SDFOutmux_btfPipe_vld;
  reg signed [17:0] SDFOutmux_btf2Pipe_re_next;  // sfix18_En5
  reg signed [17:0] SDFOutmux_btf2Pipe_im_next;  // sfix18_En5
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [17:0] dout_4_1_re_1;  // sfix18_En5
  reg signed [17:0] dout_4_1_im_1;  // sfix18_En5
  reg  dout_4_1_vld_1;
...
endmodule  // rx_dma_test_src_SDFCommutator4
