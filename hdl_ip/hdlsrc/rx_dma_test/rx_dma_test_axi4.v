// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_axi4.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_axi4
// Source Path: rx_dma_test/rx_dma_test_axi4
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module rx_dma_test_axi4
  ...
  rx_dma_test_addr_decoder u_rx_dma_test_addr_decoder_inst (.clk(AXI4_ACLK),  // ufix1
                                                            .reset(reset),
                                                            ...
                                                            .read_AccumulatorCount(read_AccumulatorCount),  // ufix32
                                                            .data_read(top_data_read),  // ufix32
                                                            .write_axi_enable(write_axi_enable),  // ufix1
                                                            .write_Accumulations(write_Accumulations),  // ufix32
                                                            .write_autoTrigger_i(write_autoTrigger_i),  // ufix1
                                                            .write_frame_rx_trigger(write_frame_rx_trigger),  // ufix1
                                                            .write_frameLen_i(write_frameLen_i),  // ufix16
                                                            .write_idleTime_i(write_idleTime_i)  // sfix24
                                                            );

  rx_dma_test_axi4_module u_rx_dma_test_axi4_module_inst (.clk(AXI4_ACLK),  // ufix1
