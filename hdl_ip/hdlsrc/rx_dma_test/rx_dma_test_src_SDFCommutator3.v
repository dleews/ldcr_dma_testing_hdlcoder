// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_src_SDFCommutator3.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_src_SDFCommutator3
// Source Path: rx_dma_test/LDCR_D/Channelizer_CH1/FFT/RADIX22FFT_SDF1_3/SDFCommutator3
// Hierarchy Level: 4
// Model version: 9.535
// 
// -------------------------------------------------------------
...
module rx_dma_test_src_SDFCommutator3
  ...
  input   enb;
  input   din_3_vld_dly;
  input   signed [16:0] xf_re;  // sfix17_En5
  input   signed [16:0] xf_im;  // sfix17_En5
  input   xf_vld;
  input   signed [16:0] dinXTwdlf_re;  // sfix17_En5
  input   signed [16:0] dinXTwdlf_im;  // sfix17_En5
  input   dinxTwdlf_vld;
  input   signed [16:0] btf1_re;  // sfix17_En5
  input   signed [16:0] btf1_im;  // sfix17_En5
  input   signed [16:0] btf2_re;  // sfix17_En5
  input   signed [16:0] btf2_im;  // sfix17_En5
  input   btf_vld;
  output  signed [16:0] wrData_re;  // sfix17_En5
  output  signed [16:0] wrData_im;  // sfix17_En5
  ...
  reg signed [16:0] SDFCummutator_out_re_next;  // sfix17_En5
  reg signed [16:0] SDFCummutator_out_im_next;  // sfix17_En5
  reg  SDFCummutator_out_vld_next;
  reg [2:0] SDFCummutator_wrAddr_reg_next;  // ufix3
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [16:0] SDFCummutator_wrData_re_reg_next;  // sfix17_En5
  reg signed [16:0] SDFCummutator_wrData_im_reg_next;  // sfix17_En5
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [16:0] SDFCummutator_wrXData_re_reg_next;  // sfix17_En5
  reg signed [16:0] SDFCummutator_wrXData_im_reg_next;  // sfix17_En5
  ...
  reg signed [16:0] wrData_re_1;  // sfix17_En5
  reg signed [16:0] wrData_im_1;  // sfix17_En5
  reg [2:0] wrAddr_1;  // ufix3
  reg  wrEnb_1;
  reg signed [16:0] xData_re;  // sfix17_En5
  reg signed [16:0] xData_im;  // sfix17_En5
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [16:0] dout0_re;  // sfix17_En5
  reg signed [16:0] dout0_im;  // sfix17_En5
  reg  dout0_vld;
  wire signed [16:0] xX_re;  // sfix17_En5
  wire signed [16:0] xX_im;  // sfix17_En5
  reg signed [16:0] SDFOutmux_btf2Pipe_re;  // sfix17
  reg signed [16:0] SDFOutmux_btf2Pipe_im;  // sfix17
  reg  SDFOutmux_btfPipe_vld;
  reg signed [16:0] SDFOutmux_btf2Pipe_re_next;  // sfix17_En5
  reg signed [16:0] SDFOutmux_btf2Pipe_im_next;  // sfix17_En5
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [16:0] dout_3_1_re_1;  // sfix17_En5
  reg signed [16:0] dout_3_1_im_1;  // sfix17_En5
  reg  dout_3_1_vld_1;
...
endmodule  // rx_dma_test_src_SDFCommutator3
