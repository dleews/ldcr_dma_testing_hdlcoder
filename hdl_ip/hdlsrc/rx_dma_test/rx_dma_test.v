...
module rx_dma_test
  ...
  wire write_autoTrigger_i;  // ufix1
  wire write_frame_rx_trigger;  // ufix1
  wire [15:0] write_frameLen_i;  // ufix16
  wire signed [23:0] write_idleTime_i;  // sfix24
  ...
  assign ip_timestamp = 32'b10010101100000000110100111111111;
  ...
  rx_dma_test_dut u_rx_dma_test_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                          ...
                                          .frame_rx_trigger(write_frame_rx_trigger),  // ufix1
                                          .autoTrigger_i(write_autoTrigger_i),  // ufix1
                                          .frameLen_i(write_frameLen_i),  // ufix16
                                          .idleTime_i(write_idleTime_i),  // sfix24
