// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_src_SDFCommutator2.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_src_SDFCommutator2
// Source Path: rx_dma_test/LDCR_D/Channelizer_CH1/FFT/RADIX22FFT_SDF2_2/SDFCommutator2
// Hierarchy Level: 4
// Model version: 9.535
// 
// -------------------------------------------------------------
...
module rx_dma_test_src_SDFCommutator2
  ...
  input   enb;
  input   dout_1_1_vld;
  input   signed [15:0] xf_re;  // sfix16_En5
  input   signed [15:0] xf_im;  // sfix16_En5
  input   xf_vld;
  input   signed [15:0] dinf_re;  // sfix16_En5
  input   signed [15:0] dinf_im;  // sfix16_En5
  input   dinf_vld;
  input   signed [15:0] btf1_re;  // sfix16_En5
  input   signed [15:0] btf1_im;  // sfix16_En5
  input   signed [15:0] btf2_re;  // sfix16_En5
  input   signed [15:0] btf2_im;  // sfix16_En5
  input   btfout_vld;
  output  signed [15:0] wrData_re;  // sfix16_En5
  output  signed [15:0] wrData_im;  // sfix16_En5
  ...
  reg signed [15:0] SDFCummutator_out_re_next;  // sfix16_En5
  reg signed [15:0] SDFCummutator_out_im_next;  // sfix16_En5
  ...
  reg signed [15:0] SDFCummutator_wrData_re_reg_next;  // sfix16_En5
  reg signed [15:0] SDFCummutator_wrData_im_reg_next;  // sfix16_En5
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [15:0] SDFCummutator_wrXData_re_reg_next;  // sfix16_En5
  reg signed [15:0] SDFCummutator_wrXData_im_reg_next;  // sfix16_En5
  ...
  reg signed [15:0] wrData_re_1;  // sfix16_En5
  reg signed [15:0] wrData_im_1;  // sfix16_En5
  reg [3:0] wrAddr_1;  // ufix4
  reg  wrEnb_1;
  reg signed [15:0] xData_re;  // sfix16_En5
  reg signed [15:0] xData_im;  // sfix16_En5
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [15:0] dout0_re;  // sfix16_En5
  reg signed [15:0] dout0_im;  // sfix16_En5
  reg  dout0_vld;
  wire signed [15:0] xX_re;  // sfix16_En5
  wire signed [15:0] xX_im;  // sfix16_En5
  reg signed [15:0] SDFOutmux_btf2Pipe_re;  // sfix16
  reg signed [15:0] SDFOutmux_btf2Pipe_im;  // sfix16
  reg  SDFOutmux_btfPipe_vld;
  reg signed [15:0] SDFOutmux_btf2Pipe_re_next;  // sfix16_En5
  reg signed [15:0] SDFOutmux_btf2Pipe_im_next;  // sfix16_En5
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [15:0] dout_2_1_re_1;  // sfix16_En5
  reg signed [15:0] dout_2_1_im_1;  // sfix16_En5
  reg  dout_2_1_vld_1;
...
endmodule  // rx_dma_test_src_SDFCommutator2
