// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_rdfifo_last.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_rdfifo_last
// Source Path: rx_dma_test/rx_dma_test_axi4/rx_dma_test_axi4_module/rx_dma_test_rdfifo_last
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module rx_dma_test_rdfifo_last
  ...
  rx_dma_test_SimpleDualPortRAM_singlebit #(.AddrWidth(4),
                                            .DataWidth(1)
                                            )
                                          u_rx_dma_test_rdfifo_last_classic_ram_singlebit (.clk(clk),
                                                                                           .enb(enb),
                                                                                           .wr_din(In),  // ufix1
                                                                                           .wr_addr(w_waddr),
                                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // rx_dma_test_rdfifo_last
