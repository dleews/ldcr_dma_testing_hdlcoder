// -------------------------------------------------------------
// 
// File Name: /home/draco/git/adi_dma_testing/iq_dma_example/hdl_ip/hdlsrc/rx_dma_test/rx_dma_test_src_RADIX22FFT_SDF1_1.v
...
// -------------------------------------------------------------
// 
// Module: rx_dma_test_src_RADIX22FFT_SDF1_1
// Source Path: rx_dma_test/LDCR_D/Channelizer_CH1/FFT/RADIX22FFT_SDF1_1
// Hierarchy Level: 3
// Model version: 9.535
// 
// -------------------------------------------------------------
...
module rx_dma_test_src_RADIX22FFT_SDF1_1
  ...
  input   reset;
  input   enb;
  input   signed [13:0] din_1_1_re_dly;  // sfix14_En5
  input   signed [13:0] din_1_1_im_dly;  // sfix14_En5
  input   din_1_vld_dly;
  ...
  wire signed [14:0] din_re;  // sfix15_En5
  reg signed [14:0] dinXTwdl_re;  // sfix15_En5
  wire signed [14:0] din_im;  // sfix15_En5
  ...
  assign din_re = {din_1_1_re_dly[13], din_1_1_re_dly};
  ...
  assign din_im = {din_1_1_im_dly[13], din_1_1_im_dly};
  ...
  rx_dma_test_src_SimpleDualPortRAM_generic #(.AddrWidth(5),
                                              .DataWidth(15)
                                              )
  ...
  rx_dma_test_src_SDFCommutator1 u_SDFCOMMUTATOR_1 (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
...
endmodule  // rx_dma_test_src_RADIX22FFT_SDF1_1
